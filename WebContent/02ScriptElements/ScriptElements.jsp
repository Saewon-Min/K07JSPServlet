<%--
	...
	지시어(Directive)
		: 페이지 속성을 지정하거나 외부 문서를 포함할때 사용한다.
...
<%--
	선언부(Declaration)
		: 스크립트릿이나 표현식에서 사용할 메소드를 선언할때 사용한다.
		함수는 중복해서 사용하는 경우가 많으므로 주로 src를 사용한다.
 --%>
<%!
...
<body>
	...
	<h2>src에 작성한 JAVA클래스 사용</h2>
	<%
	// static형으로 선언했으므로 객체 생성 없이 클래스명으로 접근 가능
	out.println("1~100까지의 합 : " + MyClass.myFunc(1,100));
	%>
	<%--
		스크립트릿(Scriptlet)
			: 주로 JSP코드를 작성하고 실행할때 사용하는 영역이다.
