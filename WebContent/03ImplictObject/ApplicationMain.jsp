...
<body>
	...
	<%-- 
	ServeletContext의 메소드인 getRealPath()로 서버의 물리절(절대)경로를
	얻어올 수 있다. 사용시 컨텍스트 루트를 제외한 /로 시작하는 절대 경로를
	...
	<%--
	 ...
	 --%>
	<%!
	// 1. this를 사용해서 ServletContext 객체 얻어오기
	String getRealPath(){
		return
	...
	2. 매개변수로 내장객체를 전달하기
		...
		따라서 매개변수로 전달한 후 내장객체를 클래스형으로 받아서
		사용해야 한다.
	*/
