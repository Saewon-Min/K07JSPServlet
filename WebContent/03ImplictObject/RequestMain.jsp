...
<body>
	...
	<%
	/*
	한글을 전송하는 경우 서버 환경에 따라 깨질수 있으므로 인코딩 후
	전달하는 것이 안전하다.
	*/
	...
	<form method="post" name="regFrm" action="RequestParameter.jsp"
		...
		<br /> 
		관심사항 : 
			<input type="checkbox" name="favorite" value="sport" checked="checked">스포츠
			<input type="checkbox" name="favorite" value="economic" >경제
			<input type="checkbox" name="favorite" value="politics" checked="checked">정치
		<br />
		성별 :
			<input type="radio" name="sex" value="man">남자
			<input type="radio" name="sex" value="wonan" checked="checked">여자
		<br />
		자기소개 :
			<textarea rows="10" cols="30" name="self_intro">
			나는 평범한 집안에서 자라서
			</textarea>
			<br />
			<input type="submit" value="POST방식">
