...
pageContext.setAttribute("nullStr", null); //null 값
...
<body>
	...
	<!--  
		...
		String이 빈 문자열일때, 컬렉션의 size가 0일때,
		배열의 길이가 0일때.
	-->
	...
	하지만 EL에서는 null을 0으로 간주하여 게산하므로
	NullPointerException이 발생하지 않는다.
	-->
	null + 10 : ${null+10 } <br />
	nullStr + 10 : ${nullStr+10 } <br />
	<!-- noVar라는 파라미터값을 지정하지 않았기 때문에 0임 -->
	param.noVar > 10 : ${param.noVar > 10 }
	<!--  
	해당페이지?noVar=99 	=>숫자로 인식하므로 true
	해당페이지?noVar=	 	=>0으로 인식하므로 false
	해당페이지?noVar=구십 	=>문자는 숫자로 변경할 수 없으므로 에러 발생됨
	-->
