...
<body>
	...
	<!--  
	false 일때는 HTML이 해석되어져서 화면에 출력된다. 
	...
	- out 태그에 value 속성의 값이 null일때는 default속성에
		지정된 값이 출력된다.
	...
	<h4>값이 null 문자열 : 값이 없는 경우에 해당</h4>
	...
	-->
	<h3>페이지 링크에 응용하기</h3>
	<c:url value="/08Board/List.jsp?pageNum=" /><c:out 
	value="${null }" default="1"/>
	<hr />
	
	<!-- [주의] 한줄로 붙여서 작성. 줄바꿈하면 공백 들어감 -->
