...
<body>
	...
	- EL이나 JSP에서 예외가 발생했을때 처리를 위해 사용된다.
	...
	<h3>에러가 안나는 경우 : 에러 내용이 저장 안됨</h3>
	
	<!--  
		Java에서 정수를 0으로 나누면 예외가 발생하지만,
		EL에서는 예외가 발생하지 않고, infinity로 출력된다.
		즉, 이 경우에는 변수에 아무런 내용도 저장되지 않는다.
	-->
	...
	이 경우 500에러가 발생하기 때문에 var에 지정한 변수에 에러 내용이
	저장된다.
	-->
