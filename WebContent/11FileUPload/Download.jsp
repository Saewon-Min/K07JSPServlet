...
<% 
// 파일이 저장된 폴더의 물리적 경로를 얻어온다.
String saveDirectory = application.getRealPath("/Uploads");
// 파라미터로 전달된 원본파일명과 저장된 파일명을 얻어온다.
...
try{
	...
	// 파일 내용을 Java로 읽어오기 위해 Input스트림 생성
	...
	2. 브라우저가 인식하지 못하는 컨텐츠 타입을 설정함
		이를 통해 웹브라우저는 파일 다운로드 창을 띄워주게 됨
	3. 파일명 변경을 위한 응답헤더 설정 및 파일 사이즈 설정
	...
	*/
	...
	/*
		...
		JSP가 열린 상태에서 다운로드를 위해 또 다른 JSP를 열면
		출력스트림이 중복으로 생성되어 예외가 발생하게 된다.
	*/
	out.clear();
