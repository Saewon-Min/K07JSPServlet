...
<body>
    ...
    <!--  
    	파일 업로드 실패시 리퀘스트영역에 저장할 에러메세지를 출력
    -->
    ...
    <!--  
    	...
    	로 설정해야 한다. 만약 get방식으로 설정하면 파일명만 텍스트 형식으로 전송되게 된다.
    -->
    
    <form name="fileFrm" method="post" enctype="multipart/form-data" action="UploadProcess.jsp"
