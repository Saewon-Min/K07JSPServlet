...
<% 
// 파일이 저장될 디렉토리의 물리적 경로(절대경로)를 읽어온다.
String saveDirectory = application.getRealPath("/Uploads");
/* 
	전송될 파일의 최대용량을 지정한다. 
	단, 파일이 3개라면 3개를 합친 용량을 설정해야한다.
*/
...
try{
	...
	*/
	...
	단, 이때 request객체를 통해서가 아니라 MultipartRequest 객체를 통해 받아와야 한다.
	*/
	...
	if(cateArray==null){
		...
		// 체크박스를 통해 선택한 항목을 콤마를 통해 구분해서 저장
	...
	e.printStackTrace();
	// 업로드에 실패한 경우 request 영역에 속성 저장 후 포워드
