		...
		<div class="col-12">			 
			...
			<nav class="navbar navbar-expand-sm bg-light navbar-dark">
				...
				<ul class="navbar-nav ml-auto" >
					...
					<li class="nav-item">
						<a class="nav-link text-dark" href="#"><i class='fas fa-sign-in-alt' style='font-size:20px' onclick="location.href='isLogin.jsp';"></i>로그인</a>
					</li>
					<li class="nav-item">
						<a class="nav-link text-dark" href="#"><i class='fas fa-sign-out-alt' style='font-size:20px' onclick="location.href='Logout.jsp';"></i>로그아웃</a>
					</li>
				</ul>
			</nav>
		</div>
